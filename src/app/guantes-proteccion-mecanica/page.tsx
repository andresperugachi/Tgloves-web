...
import { MechanicalRisks } from "@/components/RiskSections";
import SizeGuide from "@/components/SizeGuide";
import { categories, productsByCategory } from "@/lib/products";
import { siteConfig } from "@/lib/site";

const category = categories["guantes-proteccion-mecanica"];
...
export default function MechanicalCategoryPage() {
  return (
    <>
      <div className="relative isolate">
        ...
        <div className="container-page absolute inset-x-0 bottom-6">
          <p className="text-[11px] font-semibold uppercase tracking-[0.25em] text-brand">
            Línea mecánica TGloves
          </p>
          <p className="mt-2 max-w-xl text-sm text-white/85">
            Anticorte, antivibración y precisión certificados EN 388:2016.
          </p>
        </div>
      </div>
      ...
      <ProductCatalog products={items} mode="mecanica" />
      <SizeGuide />
      <MechanicalRisks />
      <CtaSection />
